...
use Atom\Database\Query\Compilers\MsSqlCompiler;

class MsSqlConnector extends AbstractConnector
{
    public function open(): PDO
    {
        $dsn = "mssql:dbname={$this->database};host={$this->host};username={$this->user};password={$this->password}";

...
class MySqlCompiler implements QueryCompiler
{
    ...
    private function compileSelect(SelectQuery $query): Command
    {
    ...
    private function compileInsert(InsertQuery $query): Command
    {
    ...
    private function compileUpdate(UpdateQuery $query): Command
    {
        $table = $query->getTable();
        if ($table === null) {
    ...
    private function compileDelete(DeleteQuery $query): Command
    {
        $table = $query->getTable();
        if ($table === null) {
    ...
    private function compileSelectExpression(SelectExpression $expression): string
    {
    ...
    private function compileAggregateExpression(string $expression): string
    {
    ...
    private function compileTable(Table $table): string
    {
    ...
    private function compileJoin(Join $join): string
    {
     ...
     */
    private function compileWhere(WhereGroup $group): string
    {
        $parts = [];
    ...
    private function compileCriteriaExpression(CriteriaExpression $expression): string
    {
     ...
     */
    private function compileValueList(array $values): string
    {
     ...
     * @param Sort[] $sorts
     */
    private function compileOrderBy(array $sorts): string
    {
        return implode(", ", array_map(
     ...
     */
    private function compileGroupBy(array $columns): string
    {
